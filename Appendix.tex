...
El ajuste nos permitió encontrar una tabla de valores para los parámetros de la hipérbola $(x_{0,t}, x_{0,t} - a_t)$. En particular, para $x_{0,t}$ se observó que la dependencia con $\beta$ tenía un comportamiento que tendía a ser de una ley de potencias, con un índice de $\sim -0.55$. En la figura  se muestra la dependencia del residuo de $x_{0,t} - a_t$ como función de $\beta$ para diferentes valores de $\xi$, mientras que en la figura se muestra la dependencia de los coeficientes $C_k$ y $D_k$ en función de \xi, ambas figuras con sus respectivos ajustes.
