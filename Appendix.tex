...
\section[Polinomio]{Radio de curvatura para un polinomio de grado $2n$}
...
\chapter[Radios característicos]{Derivación paso a paso de los Radios Característicos en la aproximación
...
\section[$R_c$]{Radio de Curvatura en el  caso de la interacción de dos vientos esféricos.}
...
\section[$R_c$ viento plano--paralelo]{Radio de Curvatura en el caso de interacción con un viento plano--paralelo}
\label{sec:Rc-Wilkin}
