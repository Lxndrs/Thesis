...
\chapter[Regiones \Ion{H}{II}]{Regiones \Ion{H}{II} \citep{Stahler:2004}}
\label{app:HII}
...
\section{Flujos de Champaña}% (\citet{Stahler:2004}, \citet{Tenorio:1979})}
...
\section{Características de la emisión} %\citep{Stahler:2004}}
...
\section{Choques (condiciones de salto)}
...
En la ecuación para la energía, son los fotones estelares los que determinan la temperatura del gas y se asume que la temperatura del frente de ionización se calienta a la temperatura de la región \Ion{H}{II} de manera instantánea. Con esto, encontramos el salto en densidad del frente de ionización:
...
\chapter[Paraboloide]{Planitud y alatud aparente del paraboloide}
