...
| Fuente  |  xi | k       |    r0 |   N6 |   D' | R0'/D' |  Pi' | \beta | * | i (deg) | R0/D |     D |   R0 | R0/r0  | P(in) | P(wind) | P(in)/P(wind) | F(photo) | F(star) | F(ph)/F(*) |
|---------+-----+---------+-------+------+------+--------+------+-------+---+---------+------+-------+------+--------+-------+---------+---------------+----------+---------+------------|
| LV2     | 0.8 | 0.5     | 0.120 | 2.53 | 7.76 |   0.25 | 1.48 | 0.002 |   |      70 | 0.04 | 22.69 | 0.91 | 189.08 |       |         |               |          |         |            |
| LV2     | 0.8 | 0.5     | 0.120 | 2.53 | 7.76 |   0.25 | 1.48 | 0.005 |   |      65 | 0.07 | 18.36 | 1.29 | 153.00 |       |         |               |          |         |            |
| LV2     | 0.4 | 3.0     | 0.120 | 2.53 | 7.76 |        |      |       |   |         |    0 |  7.76 | 0.00 | 64.67  |       |         |               |          |         |            |
| LV2     | 0.4 | 3.0     | 0.120 | 2.53 | 7.76 |        |      |       |   |         |    0 |  7.76 | 0.00 | 64.67  |       |         |               |          |         |            |
| LV2     | 0.4 | 3.0     | 0.120 | 2.53 | 7.76 |        |      |       |   |         |    0 |  7.76 | 0.00 | 64.67  |       |         |               |          |         |            |
| LV2     | 0.2 | 8.0     | 0.120 | 2.53 | 7.76 |        |      |       |   |         |    0 |  7.76 | 0.00 | 64.67  |       |         |               |          |         |            |
| LV2     | 0.1 | 18.0    | 0.120 | 2.53 | 7.76 |        |      |       |   |         |    0 |  7.76 | 0.00 | 64.67  |       |         |               |          |         |            |
|---------+-----+---------+-------+------+------+--------+------+-------+---+---------+------+-------+------+--------+-------+---------+---------------+----------+---------+------------|
| LV2b    |     | 2/0 - 2 |       |      |      |        |      |       |   |         |    0 |     0 |    0 | 0/0    |       |         |               |          |         |            |
|---------+-----+---------+-------+------+------+--------+------+-------+---+---------+------+-------+------+--------+-------+---------+---------------+----------+---------+------------|
| LV3     |     | 2/0 - 2 |       |      |      |        |      |       |   |         |    0 |     0 |    0 | 0/0    |       |         |               |          |         |            |
|---------+-----+---------+-------+------+------+--------+------+-------+---+---------+------+-------+------+--------+-------+---------+---------------+----------+---------+------------|
| LV4     |     | 2/0 - 2 |       |      |      |        |      |       |   |         |    0 |     0 |    0 | 0/0    |       |         |               |          |         |            |
...
| LV5     |     | 2/0 - 2 |       |      |      |        |      |       |   |         |    0 |     0 |    0 | 0/0    |       |         |               |          |         |            |
|---------+-----+---------+-------+------+------+--------+------+-------+---+---------+------+-------+------+--------+-------+---------+---------------+----------+---------+------------|
| 169-338 |     | 2/0 - 2 |       |      |      |        |      |       |   |         |    0 |     0 |    0 | 0/0    |       |         |               |          |         |            |
|---------+-----+---------+-------+------+------+--------+------+-------+---+---------+------+-------+------+--------+-------+---------+---------------+----------+---------+------------|
| 177-341 |     | 2/0 - 2 |       |      |      |        |      |       |   |         |    0 |     0 |    0 | 0/0    |       |         |               |          |         |            |
|---------+-----+---------+-------+------+------+--------+------+-------+---+---------+------+-------+------+--------+-------+---------+---------------+----------+---------+------------|
| 180-331 |     | 2/0 - 2 |       |      |      |        |      |       |   |         |    0 |     0 |    0 | 0/0    |       |         |               |          |         |            |
|         |     | 2/0 - 2 |       |      |      |        |      |       |   |         |    0 |     0 |    0 | 0/0    |       |         |               |          |         |            |
#+TBLFM: $3=2/$2-2;f1::$12=sqrt($9)/(1 + sqrt($9));f2::$13=$6/cos($11);f2::$14=$12*$13;f2::$15=$13/$4;f2
