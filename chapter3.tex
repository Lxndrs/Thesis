...
Sustituyendo estas ecuaciones en () junto con () - () obtenemos lo siguiente:
...
La condición de equilibrio de presión en este caso nos lleva a que $\frac{\dot{M}^0_w v_w}{4\pi R^2_0} = \rho_a v^2_a$. Por tanto:

\begin{align}
  \tilde{R} = \frac{\frac{2}{3}\tilde{R}^3 \sin^3\theta}{\left(\theta-\sin\theta\cos\theta\right)\cos\theta
  - \left(\frac{\sin^2\theta - \tilde{R}^2 \sin^2\theta\right)\sin\theta}
\end{align}

Resolviendo para $\tilde{R}$ encontramos que:

\begin{align}
  \tilde{R}^2 = \csc^2\theta\left(1 - \theta\cot\theta\right) \label{eq:R-Wilkin}
\end{align}
