...
\frame{\frametitle{Motivation of this work}
\twocols{We do this by measuring two adimensional parameters: the planitude $\Pi=R_c/R_0$ and the alatude $\Lambda=R_{90}/R_0$ easily measurables from observations and comparing each other.}{\includegraphics[width=\linewidth]{../Figures/radii-scheme}}
}
