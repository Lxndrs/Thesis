...
\frame[label=Robberto]{
  \twocols{\begin{block}{}
      Some of the nearest proplyds to \thC{} were previously observed by \citet{Bally:1998} (hyperlink{bally}{\beamergotobutton{slide 11}}) and \citet{Robberto:2005} in mid infrared and their shape analyzed using the Thin Shell Model from \citep{Canto:1996}, but some proplyds don't fit at all.
    \end{block}}{\begin{block}{}
...
\frame{
  \begin{block}{}
    The relevant parameters of the winds are the density at the shock's position, the terminal velocity and the mass loss rate. Following \citep{Canto:1996}, the density and terminal velocity of the inner (weaker) wind are $(\rho_w, v_w, \dot{M}^0_w)$ and for the outer wind we have $(\rho_{w1}, V_{w1}, \dot{M}^0_{w1})$
  \end{block}}
\frame{\begin{block}{}
